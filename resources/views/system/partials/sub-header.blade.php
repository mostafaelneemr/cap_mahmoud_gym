    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
        ...
        <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
            ...
            <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a @if(isset($value['url'])) href="{!!url($value['url'])!!}" @endif
                            class="text-muted @if(isset($value['url'])) text-hover-primary @endif">{!!$value['text']!!}</a>
                    </li>
                    <!--end::Item-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                @if(isset($addButton))
                {!!add_links(route($addButton['route']),$addButton['route']
                ,!empty($addButton['text'])?$addButton['text']:'')!!}
                @endif
                @if(isset($addModalIcon))
                {!!link_add_modal_icon($addModalIcon['route'],$addModalIcon['modalId'],(isset($addModalIcon['title']) ?
                $addModalIcon['title'] : null))!!}
                @endif
